...
class karing_root_controller : public drogon::HttpController<karing_root_controller> {
 public:
  ...
  ADD_METHOD_TO(karing_root_controller::move_karing, "/move", drogon::Post);
  ...
  void move_karing(const drogon::HttpRequestPtr& req, std::function<void(const drogon::HttpResponsePtr&)>&& cb);
